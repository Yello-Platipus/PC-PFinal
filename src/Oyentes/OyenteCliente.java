                ...
                while(!men.getTipo().equals("CerrarConexion")){
                    ...
                    switch (men.getTipo()){
                        ...
                        case "PedirFichero":
                            ...
                            outCliente2.writeObject(new MensajePedirCliente(aux1.getDestino(),aux1.getOrigen(), aux1.getFichero()));//3- Enviarle un mensaje de tipo "PedirSocket" con el socket del cliente 2
